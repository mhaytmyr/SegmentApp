...
def prostate_struct(roiName):
    ...
    if "body" in roiName: return 0 
    elif "bexiga" in roiName or "bladder" in roiName: return 1
    elif "reto"==roiName or "rectum"==roiName: return 2 
    elif "cfd" in roiName or "cfe" in roiName or "femur" in roiName: return 3
    elif "ctv" in roiName: return 4
    elif "sigmoide"==roiName: return 5 
    else: return 0;
